...
import type { InsuranceTemplateDTO, CreateInsuranceTemplateDTO, UpdateInsuranceTemplateDTO } from "../dtos/insuranceTemplate.dto";
...
// 🔹 Domain → API (Create)
export const toCreateDTO = (input: CreateInsuranceTemplateInput): CreateInsuranceTemplateDTO => ({
...
// 🔹 Domain → API (Update)
export const toUpdateDTO = (input: UpdateInsuranceTemplateInput): UpdateInsuranceTemplateDTO => ({
