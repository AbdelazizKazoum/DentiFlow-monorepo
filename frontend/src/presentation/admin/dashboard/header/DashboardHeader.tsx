      ...
      <div className="flex items-center justify-end gap-1.5 md:gap-3 w-auto md:w-1/4">
        ...
        <div className="flex items-center">
          <button
            ...
            className="p-2 text-text-muted hover:bg-surface-hover hover:text-foreground transition-all rounded-full"
            title="Toggle theme"
          >
            {theme === "dark" ? <Sun size={20} /> : <Moon size={20} />}
          </button>
          <button
            className="relative p-2 text-text-muted hover:bg-surface-hover hover:text-foreground transition-all rounded-full"
            title="Notifications"
          >
            <Bell size={20} />
          ...
          <button
            className="flex items-center gap-2 p-2 text-text-muted hover:bg-surface-hover hover:text-foreground transition-colors rounded-full"
            title="Settings"
          >
            <Settings size={20} />
          </button>
          <div className="w-px h-6 bg-ui-border mx-2 hidden md:block"></div>
