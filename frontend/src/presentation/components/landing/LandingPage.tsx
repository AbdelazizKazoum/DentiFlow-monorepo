    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-blue-100 selection:text-blue-900">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
            ...
            >
              ...
              <h1 className="text-5xl lg:text-7xl font-bold leading-[1.1] text-slate-900 mb-6">
                Your <span className="text-blue-600">Best Dental</span>{" "}
                Experience Awaits
              </h1>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-white rounded-[20px] shadow-2xl shadow-blue-900/10 p-4 lg:p-4 border border-blue-50">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-8 items-end">
              ...
              <Button className="h-[52px] text-sm w-full rounded-2xl">
                Book an Appointment
              </Button>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            ...
            >
              ...
              <p className="text-slate-500 text-lg mb-8 leading-relaxed">
                ...
                been providing award-winning dental services with a
                patient-first approach for over a decade.
              </p>
      ...
      <section className="py-24 bg-slate-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Button variant="primary" className="md:hidden w-full mt-10">
            Explore All Services
          </Button>
        </div>
      </section>
